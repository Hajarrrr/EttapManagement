...
def default_site_config(apps, schema_editor):
    ...
    Config.objects.bulk_create([
        Config(key='school_name', value='ETAP'),
        Config(key='school_slogan', value='Ecole des Techniciens en Technologies Appliquées'),
        Config(key='school_address', value='Marrakech, Maroc'),
    ])
